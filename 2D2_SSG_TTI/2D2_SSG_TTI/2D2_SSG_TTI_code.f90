...
Subroutine Wave_Field_Modeling(delt_x,delt_z,delt_h,reflect_coefficient,fre_wavelet,delay_source_t0,nt,delt_t,&
  ...
  Real :: c11(-ml:nx+ml,-ml:nz+ml),c13(-ml:nx+ml,-ml:nz+ml),&
          c15(-ml:nx+ml,-ml:nz+ml),c33(-ml:nx+ml,-ml:nz+ml),&
          c35(-ml:nx+ml,-ml:nz+ml),c55(-ml:nx+ml,-ml:nz+ml)       !VTI介质弹性常数
  ...
  Open(110,file='参数.dat')
  Open(13,file=Input_file_modelpar,status='old')
  Read(13,*)
  Do j=1,nz
    Do i=1,nx
      Read(13,*) xx,zz,c11(i,j),c13(i,j),c15(i,j),c33(i,j),c35(i,j),c55(i,j),density(i,j)
      Write(110,'(9E12.3/)') xx,zz,c11(i,j),c13(i,j),c15(i,j),c33(i,j),c35(i,j),c55(i,j),density(i,j)
    End Do
  End Do
  Close(13)
  Close(110)
  ...
  Do j=1,nz
    Do i=1,nx
      ...
      vs(i,j)=sqrt(c55(i,j)/density(i,j))
    End Do
  End Do
    ...
    Else
      ...
      Do j=1,nz
        Do i=1,nx
          ...
          d11=vx(i,j+1,2)-vx(i,j,2)
          d12=vx(i,j+2,2)-vx(i,j-1,2)
          d13=vx(i,j+3,2)-vx(i,j-2,2)
          d14=vx(i,j+4,2)-vx(i,j-3,2)
          d21=vz(i,j,2)-vz(i-1,j,2)
          d22=vz(i+1,j,2)-vz(i-2,j,2)
          d23=vz(i+2,j,2)-vz(i-3,j,2)
          d24=vz(i+3,j,2)-vz(i-4,j,2)
          txx(i,j,2)=txx(i,j,1)+r1*c11(i,j)*(ef1*a11-ef2*a12+ef3*a13-ef4*a14)+r2*c13(i,j)*(ef1*a21-ef2*a22+ef3*a23-ef4*a24)+&
                                r1*c15(i,j)*(ef1*d21-ef2*d22+ef3*d23-ef4*d24)+r2*c15(i,j)*(ef1*d11-ef2*d12+ef3*d13-ef4*d14)
          tzz(i,j,2)=tzz(i,j,1)+r1*c13(i,j)*(ef1*b21-ef2*b22+ef3*b23-ef4*b24)+r2*c33(i,j)*(ef1*b11-ef2*b12+ef3*b13-ef4*b14)+&
                                r1*c35(i,j)*(ef1*d21-ef2*d22+ef3*d23-ef4*d24)+r2*c35(i,j)*(ef1*d11-ef2*d12+ef3*d13-ef4*d14)
          txz(i,j,2)=txz(i,j,1)+r1*c15(i,j)*(ef1*a11-ef2*a12+ef3*a13-ef4*a14)+r2*c35(i,j)*(ef1*a21-ef2*a22+ef3*a23-ef4*a24)+&
                                r1*c55(i,j)*(ef1*d21-ef2*d22+ef3*d23-ef4*d24)+r2*c55(i,j)*(ef1*d11-ef2*d12+ef3*d13-ef4*d14)
        End Do
      End Do
      ...
      Do j=1,nz                   !i=1--->-(ml-1), i=ml--->0	  左边界
        Do i=4,ml
          ...
          d14=vz(-ml+i+3,j,2)-vz(-ml+i-4,j,2)
	        s1=r1*c11(-ml+i,j)*(ef1*a11-ef2*a12+ef3*a13-ef4*a14)+r1*c15(-ml+i,j)*(ef1*d11-ef2*d12+ef3*d13-ef4*d14)
          ...
          s1=r2*c13(-ml+i,j)*(ef1*a21-ef2*a22+ef3*a23-ef4*a24)+r2*c15(-ml+i,j)*(ef1*d21-ef2*d22+ef3*d23-ef4*d24)
	        s2=0.0 
          ...
          d13=vz(-ml+i+2,j,2)-vz(-ml+i-3,j,2)
          d14=vz(-ml+i+3,j,2)-vz(-ml+i-4,j,2)
	        s1=r1*c13(-ml+i,j)*(ef1*b21-ef2*b22+ef3*b23-ef4*b24)+r1*c35(-ml+i,j)*(ef1*d11-ef2*d12+ef3*d13-ef4*d14)
          ...
          d23=vx(-ml+i,j+3,2)-vx(-ml+i,j-2,2)
          d24=vx(-ml+i,j+4,2)-vx(-ml+i,j-3,2)
	        s1=r2*c33(-ml+i,j)*(ef1*b11-ef2*b12+ef3*b13-ef4*b14)+r2*c35(-ml+i,j)*(ef1*d21-ef2*d22+ef3*d23-ef4*d24)
	        s2=0.0
          ...
          d12=vz(-ml+i+1,j,2)-vz(-ml+i-2,j,2)
	        d13=vz(-ml+i+2,j,2)-vz(-ml+i-3,j,2)
	        d14=vz(-ml+i+3,j,2)-vz(-ml+i-4,j,2)
	        s1=r1*c15(-ml+i,j)*(ef1*a11-ef2*a12+ef3*a13-ef4*a14)+r1*c55(-ml+i,j)*(ef1*d11-ef2*d12+ef3*d13-ef4*d14)
          ...
          d22=vx(-ml+i,j+2,2)-vx(-ml+i,j-1,2)
	        d23=vx(-ml+i,j+3,2)-vx(-ml+i,j-2,2)
	        d24=vx(-ml+i,j+4,2)-vx(-ml+i,j-3,2)
	        s1=r2*c35(-ml+i,j)*(ef1*b11-ef2*b12+ef3*b13-ef4*b14)+r2*c55(-ml+i,j)*(ef1*d21-ef2*d22+ef3*d23-ef4*d24)
	        s2=0.0
      ...
      Do j=1,nz                !i=1--->-(ml-1), i=ml--->nx+1 右边界
        Do i=ml,5,-1
          ...
          d14=vz(nx1-i+3,j,2)-vz(nx1-i-4,j,2)
	        s1=r1*c11(nx1-i,j)*(ef1*a11-ef2*a12+ef3*a13-ef4*a14)+r1*c15(nx1-i,j)*(ef1*d11-ef2*d12+ef3*d13-ef4*d14)
          ...
          d24=vx(nx1-i,j+4,2)-vx(nx1-i,j-3,2)
	        s1=r2*c13(nx1-i,j)*(ef1*a21-ef2*a22+ef3*a23-ef4*a24)+r2*c15(nx1-i,j)*(ef1*d21-ef2*d22+ef3*d23-ef4*d24)
	        s2=0.0 
          ...
          d13=vz(nx1-i+2,j,2)-vz(nx1-i-3,j,2)
          d14=vz(nx1-i+3,j,2)-vz(nx1-i-4,j,2)
	        s1=r1*c13(nx1-i,j)*(ef1*b21-ef2*b22+ef3*b23-ef4*b24)+r1*c35(nx1-i,j)*(ef1*d11-ef2*d12+ef3*d13-ef4*d14)
          ...
          d23=vx(nx1-i,j+3,2)-vx(nx1-i,j-2,2)
          d24=vx(nx1-i,j+4,2)-vx(nx1-i,j-3,2)
	        s1=r2*c33(nx1-i,j)*(ef1*b11-ef2*b12+ef3*b13-ef4*b14)+r2*c35(nx1-i,j)*(ef1*d21-ef2*d22+ef3*d23-ef4*d24)
	        s2=0.0
          ...
          d12=vz(nx1-i+1,j,2)-vz(nx1-i-2,j,2)
	        d13=vz(nx1-i+2,j,2)-vz(nx1-i-3,j,2)
	        d14=vz(nx1-i+3,j,2)-vz(nx1-i-4,j,2)
	        s1=r1*c15(nx1-i,j)*(ef1*a11-ef2*a12+ef3*a13-ef4*a14)+r1*c55(nx1-i,j)*(ef1*d11-ef2*d12+ef3*d13-ef4*d14)
          ...
          d22=vx(nx1-i,j+2,2)-vx(nx1-i,j-1,2)
	        d23=vx(nx1-i,j+3,2)-vx(nx1-i,j-2,2)
	        d24=vx(nx1-i,j+4,2)-vx(nx1-i,j-3,2)
	        s1=r2*c35(nx1-i,j)*(ef1*b11-ef2*b12+ef3*b13-ef4*b14)+r2*c55(nx1-i,j)*(ef1*d21-ef2*d22+ef3*d23-ef4*d24)
	        s2=0.0
      ...
      Do j=4,ml                   ! j=ml--->0	  上边界
        Do i=-ml+4,nx+ml-4
          ...
          d14=vz(i+3,-ml+j,2)-vz(i-4,-ml+j,2)
	        s1=r1*c11(i,-ml+j)*(ef1*a11-ef2*a12+ef3*a13-ef4*a14)+r1*c15(i,-ml+j)*(ef1*d11-ef2*d12+ef3*d13-ef4*d14)
          ...
          s1=r2*c13(i,-ml+j)*(ef1*a21-ef2*a22+ef3*a23-ef4*a24)+r2*c15(i,-ml+j)*(ef1*d21-ef2*d22+ef3*d23-ef4*d24)
          ...
          d13=vz(i+2,-ml+j,2)-vz(i-3,-ml+j,2)
          d14=vz(i+3,-ml+j,2)-vz(i-4,-ml+j,2)
	        s1=r1*c13(i,-ml+j)*(ef1*b21-ef2*b22+ef3*b23-ef4*b24)+r1*c35(i,-ml+j)*(ef1*d11-ef2*d12+ef3*d13-ef4*d14)
          ...
          d23=vx(i,-ml+j+3,2)-vx(i,-ml+j-2,2)
          d24=vx(i,-ml+j+4,2)-vx(i,-ml+j-3,2)
          s1=r2*c33(i,-ml+j)*(ef1*b11-ef2*b12+ef3*b13-ef4*b14)+r2*c35(i,-ml+j)*(ef1*d21-ef2*d22+ef3*d23-ef4*d24)
          ...
          d12=vz(i+1,-ml+j,2)-vz(i-2,-ml+j,2)
	        d13=vz(i+2,-ml+j,2)-vz(i-3,-ml+j,2)
	        d14=vz(i+3,-ml+j,2)-vz(i-4,-ml+j,2)
	        s1=r1*c15(i,-ml+j)*(ef1*a11-ef2*a12+ef3*a13-ef4*a14)+r1*c55(i,-ml+j)*(ef1*d11-ef2*d12+ef3*d13-ef4*d14)
          ...
          d22=vx(i,-ml+j+2,2)-vx(i,-ml+j-1,2)
	        d23=vx(i,-ml+j+3,2)-vx(i,-ml+j-2,2)
	        d24=vx(i,-ml+j+4,2)-vx(i,-ml+j-3,2)
	        s1=r2*c35(i,-ml+j)*(ef1*b11-ef2*b12+ef3*b13-ef4*b14)+r2*c55(i,-ml+j)*(ef1*d21-ef2*d22+ef3*d23-ef4*d24)
      ...
      Do j=ml,5,-1                ! j=ml--->nz+1 下边界
        Do i=-ml+4,nx+ml-4
          ...
          d14=vz(i+3,nz1-j,2)-vz(i-4,nz1-j,2)
	        s1=r1*c11(i,nz1-j)*(ef1*a11-ef2*a12+ef3*a13-ef4*a14)+r1*c15(i,nz1-j)*(ef1*d11-ef2*d12+ef3*d13-ef4*d14)
          ...
          d24=vx(i,nz1-j+4,2)-vx(i,nz1-j-3,2)
	        s1=r2*c13(i,nz1-j)*(ef1*a21-ef2*a22+ef3*a23-ef4*a24)+r2*c15(i,nz1-j)*(ef1*d21-ef2*d22+ef3*d23-ef4*d24)
          ...
          d13=vz(i+2,nz1-j,2)-vz(i-3,nz1-j,2)
          d14=vz(i+3,nz1-j,2)-vz(i-4,nz1-j,2)
	        s1=r1*c13(i,nz1-j)*(ef1*b21-ef2*b22+ef3*b23-ef4*b24)+r1*c35(i,nz1-j)*(ef1*d11-ef2*d12+ef3*d13-ef4*d14)
          ...
          d23=vx(i,nz1-j+3,2)-vx(i,nz1-j-2,2)
          d24=vx(i,nz1-j+4,2)-vx(i,nz1-j-3,2)
	        s1=r2*c33(i,nz1-j)*(ef1*b11-ef2*b12+ef3*b13-ef4*b14)+r2*c35(i,nz1-j)*(ef1*d21-ef2*d22+ef3*d23-ef4*d24)
          ...
          d12=vz(i+1,nz1-j,2)-vz(i-2,nz1-j,2)
	        d13=vz(i+2,nz1-j,2)-vz(i-3,nz1-j,2)
	        d14=vz(i+3,nz1-j,2)-vz(i-4,nz1-j,2)
	        s1=r1*c15(i,nz1-j)*(ef1*a11-ef2*a12+ef3*a13-ef4*a14)+r1*c55(i,nz1-j)*(ef1*d11-ef2*d12+ef3*d13-ef4*d14)
          ...
          d22=vx(i,nz1-j+2,2)-vx(i,nz1-j-1,2)
	        d23=vx(i,nz1-j+3,2)-vx(i,nz1-j-2,2)
	        d24=vx(i,nz1-j+4,2)-vx(i,nz1-j-3,2)
	        s1=r2*c35(i,nz1-j)*(ef1*b11-ef2*b12+ef3*b13-ef4*b14)+r2*c55(i,nz1-j)*(ef1*d21-ef2*d22+ef3*d23-ef4*d24)
