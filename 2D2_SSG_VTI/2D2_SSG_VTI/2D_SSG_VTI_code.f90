...
Subroutine Wave_Field_Modeling(delt_x,delt_z,delt_h,reflect_coefficient,fre_wavelet,delay_source_t0,nt,delt_t,&
  ...
  Real :: c11(-ml:nx+ml,-ml:nz+ml),c13(-ml:nx+ml,-ml:nz+ml),&
          c33(-ml:nx+ml,-ml:nz+ml),c44(-ml:nx+ml,-ml:nz+ml)       !VTI介质弹性常数
    ...
    Else
      ...
      Do j=1,nz
        Do i=1,nx
          ...
          tzz(i,j,2)=tzz(i,j,1)+r2*c33(i,j)*(ef1*b11-ef2*b12+ef3*b13-ef4*b14)+r1*c13(i,j)*(ef1*b21-ef2*b22+ef3*b23-ef4*b24)    
          txz(i,j,2)=txz(i,j,1)+r2*c44(i,j)*(ef1*d11-ef2*d12+ef3*d13-ef4*d14)++r1*c44(i,j)*(ef1*d21-ef2*d22+ef3*d23-ef4*d24)
        End Do
      End Do
      ...
      Do j=1,nz                   !i=1--->-(ml-1), i=ml--->0	  左边界
        Do i=4,ml
          ...
          a12=vx(-ml+i+2,j,2)-vx(-ml+i-1,j,2)
	        ...
	        s1=r1*c11(-ml+i,j)*(ef1*a11-ef2*a12+ef3*a13-ef4*a14)
          ...
          a22=vz(-ml+i,j+1,2)-vz(-ml+i,j-2,2)
	        ...
	        s1=r2*c13(-ml+i,j)*(ef1*a21-ef2*a22+ef3*a23-ef4*a24)
	        s2=0.0 
          ...
          b22=vx(-ml+i+2,j,2)-vx(-ml+i-1,j,2)
	        ...
	        s1=r1*c13(-ml+i,j)*(ef1*b21-ef2*b22+ef3*b23-ef4*b24)
          ...
          b12=vz(-ml+i,j+1,2)-vz(-ml+i,j-2,2)
	        ...
	        s1=r2*c33(-ml+i,j)*(ef1*b11-ef2*b12+ef3*b13-ef4*b14)
	        s2=0.0
          ...
          d12=vz(-ml+i+1,j,2)-vz(-ml+i-2,j,2)
	        ...
	        s1=r2*c44(-ml+i,j)*(ef1*d11-ef2*d12+ef3*d13-ef4*d14)
          ...
          d22=vx(-ml+i,j+2,2)-vx(-ml+i,j-1,2)
	        ...
	        s1=r1*c44(-ml+i,j)*(ef1*d21-ef2*d22+ef3*d23-ef4*d24)
	        s2=0.0
      ...
      Do j=1,nz                !i=1--->-(ml-1), i=ml--->nx+1 右边界
        Do i=ml,5,-1
          ...
          a12=vx(nx1-i+2,j,2)-vx(nx1-i-1,j,2)
	        ...
	        s1=r1*c11(nx1-i,j)*(ef1*a11-ef2*a12+ef3*a13-ef4*a14)
          ...
          a22=vz(nx1-i,j+1,2)-vz(nx1-i,j-2,2)
	        ...
	        s1=r2*c13(nx1-i,j)*(ef1*a21-ef2*a22+ef3*a23-ef4*a24)
	        s2=0.0 
          ...
          b22=vx(nx1-i+2,j,2)-vx(nx1-i-1,j,2)
	        ...
	        s1=r1*c13(nx1-i,j)*(ef1*b21-ef2*b22+ef3*b23-ef4*b24)
          ...
          b12=vz(nx1-i,j+1,2)-vz(nx1-i,j-2,2)
	        ...
	        s1=r2*c33(nx1-i,j)*(ef1*b11-ef2*b12+ef3*b13-ef4*b14)
	        s2=0.0
          ...
          d12=vz(nx1-i+1,j,2)-vz(nx1-i-2,j,2)
	        ...
	        s1=r2*c44(nx1-i,j)*(ef1*d11-ef2*d12+ef3*d13-ef4*d14)
          ...
          d22=vx(nx1-i,j+2,2)-vx(nx1-i,j-1,2)
	        ...
	        s1=r1*c44(nx1-i,j)*(ef1*d21-ef2*d22+ef3*d23-ef4*d24)
	        s2=0.0
      ...
      Do j=4,ml                   ! j=ml--->0	  上边界
        Do i=-ml+4,nx+ml-4
          ...
          a12=vx(i+2,-ml+j,2)-vx(i-1,-ml+j,2)
	        ...
	        s1=r1*c11(i,-ml+j)*(ef1*a11-ef2*a12+ef3*a13-ef4*a14)
          ...
          a22=vz(i,-ml+j+1,2)-vz(i,-ml+j-2,2)
	        ...
	        s1=r2*c13(i,-ml+j)*(ef1*a21-ef2*a22+ef3*a23-ef4*a24)
          ...
          b22=vx(i+2,-ml+j,2)-vx(i-1,-ml+j,2)
	        ...
	        s1=r1*c13(i,-ml+j)*(ef1*b21-ef2*b22+ef3*b23-ef4*b24)
          ...
          b12=vz(i,-ml+j+1,2)-vz(i,-ml+j-2,2)
	        ...
	        s1=r2*c33(i,-ml+j)*(ef1*b11-ef2*b12+ef3*b13-ef4*b14)
          ...
          d12=vz(i+1,-ml+j,2)-vz(i-2,-ml+j,2)
	        ...
	        s1=r2*c44(i,-ml+j)*(ef1*d11-ef2*d12+ef3*d13-ef4*d14)
          ...
          d22=vx(i,-ml+j+2,2)-vx(i,-ml+j-1,2)
	        ...
	        s1=r1*c44(i,-ml+j)*(ef1*d21-ef2*d22+ef3*d23-ef4*d24)
      ...
      Do j=ml,5,-1                ! j=ml--->nz+1 下边界
        Do i=-ml+4,nx+ml-4
          ...
          a12=vx(i+2,nz1-j,2)-vx(i-1,nz1-j,2)
	        ...
	        s1=r1*c11(i,nz1-j)*(ef1*a11-ef2*a12+ef3*a13-ef4*a14)
          ...
          a22=vz(i,nz1-j+1,2)-vz(i,nz1-j-2,2)
	        ...
	        s1=r2*c13(i,nz1-j)*(ef1*a21-ef2*a22+ef3*a23-ef4*a24)
          ...
          b22=vx(i+2,nz1-j,2)-vx(i-1,nz1-j,2)
	        ...
	        s1=r1*c13(i,nz1-j)*(ef1*b21-ef2*b22+ef3*b23-ef4*b24)
          ...
          b12=vz(i,nz1-j+1,2)-vz(i,nz1-j-2,2)
	        ...
	        s1=r2*c33(i,nz1-j)*(ef1*b11-ef2*b12+ef3*b13-ef4*b14)
          ...
          d12=vz(i+1,nz1-j,2)-vz(i-2,nz1-j,2)
	        ...
	        s1=r2*c44(i,nz1-j)*(ef1*d11-ef2*d12+ef3*d13-ef4*d14)
          ...
          d22=vx(i,nz1-j+2,2)-vx(i,nz1-j-1,2)
	        ...
	        s1=r1*c44(i,nz1-j)*(ef1*d21-ef2*d22+ef3*d23-ef4*d24)
