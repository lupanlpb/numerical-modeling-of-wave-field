      ...
      Do j=1,nz
        Do i=1,nx
          ...
          vx(i,j,2)=vx(i,j,1)+1/density(i,j)*r1*((ef1*a11-ef2*a12+ef3*a13-ef4*a14)+(ef1*a21-ef2*a22+ef3*a23-ef4*a24))+&
	        ...
	        vz(i,j,2)=vz(i,j,1)+1/density(i,j)*r1*((ef1*b11-ef2*b12+ef3*b13-ef4*b14)+(ef1*b21-ef2*b22+ef3*b23-ef4*b24))+&
                              1/density(i,j)*r2*((ef1*d11-ef2*d12+ef3*d13-ef4*d14)-(ef1*d21-ef2*d22+ef3*d23-ef4*d24))
          vy(i,j,2)=vy(i,j,1)+1/density(i,j)*r1*((ef1*e11-ef2*e12+ef3*e13-ef4*e14)+(ef1*e21-ef2*e22+ef3*e23-ef4*e24))+&
                              1/density(i,j)*r2*((ef1*f11-ef2*f12+ef3*f13-ef4*f14)-(ef1*f21-ef2*f22+ef3*f23-ef4*f24))
        End Do
      End Do
